@extends('../layout')
@section('title')
  Historial de clientes - Optica Ramirez
@endsection
@section('css')
...
@section('content')
  <div class="container-fluid">
  	<div class="col-md-12 well form">
  		<fieldset>
  			<legend>Lista de clientes - Historial</legend>
    ...
    <thead>
      <tr>
        ...
        <th data-dynatable-column="button">Fotografias</th>
      </tr>
    </thead>
    <tbody>
  ...
  <script type="text/javascript">
    $(document).on('ready', function(){
      ...
      for(var i=0; i<clients.length; i++)
      {
        ...
        clients[i].fullname=clients[i].nam_cli+' '+clients[i].lpa_cli+' '+clients[i].lma_cli;
